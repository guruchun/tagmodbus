...
{
    public class ServerModbusConfig
    {
    ...
    public class AppConfig
    {
        ...
        public ServerModbusConfig ModbusConf { get; set; } = new();
        ...
        // Static accessors
        public static ServerModbusConfig Modbus { get { _instance ??= Load(); return _instance.ModbusConf; } }
        ...
        {
            _configPath = Path.Combine(Application.StartupPath, "config", "server-config.json");
            try
            {
        ...
        /// <summary>
        /// Saves current config to server-config.json.
        /// </summary>
